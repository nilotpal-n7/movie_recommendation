...
class MyListViewGenre extends StatefulWidget {
  final String category;
  final bool isAnime;
  final int genreId;

  const MyListViewGenre({
    super.key,
  ...
  @override
  State<MyListViewGenre> createState() => _MyListViewGenreState();
}

class _MyListViewGenreState extends State<MyListViewGenre> {
  ...
  Future<void> loadMovies() async {
    try {
      final fetched = await service.getMoviesByGenre(widget.category, widget.genreId);
      fetched.shuffle();
